...
public class LiveGameAdapter extends GameAdapter {

	public LiveGameAdapter(Context ctx, List<CompetitionView> competitions) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.live_competition_listitem,
					null);
			...
			holder.creditWager = (TextView) convertView
					.findViewById(R.id.creditWager);
			holder.maxRewards = (TextView) convertView
					.findViewById(R.id.maxRewards);
		...
		holder.creditWager.setText(competitions.get(position).creditWager + "");
		holder.maxRewards.setText(competitions.get(position).maxRewards);
		return convertView;
	}
}