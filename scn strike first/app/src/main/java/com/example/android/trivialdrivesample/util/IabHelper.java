...
// This is the key line that fixed everything for me
	...
	public void launchPurchaseFlow(Activity act, String sku, String itemType,
		...
		try {
			...
			e.printStackTrace();
			CommonUtil
					.commonGameErrorDialog(
                            act,
                            "There was some problem purchasing the item. Please make sure you are logged into Google Play.");
			return;
		}
...
/**
	 ...
	 *            if true, SKU details (prize, description, etc) will be queried
