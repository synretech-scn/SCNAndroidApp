...
public class WebDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		contentFrameLayout.setPadding(margins.first, margins.second,
				margins.first, margins.second);
	...
	private Pair<Integer, Integer> getMargins() {
		...
		if (scaledWidth <= NO_BUFFER_SCREEN_WIDTH) {
			...
			// between the NO_BUFFER and MAX_BUFFER widths, we take a linear
	...
	private static class BuilderBase<CONCRETE extends BuilderBase<?>> {
		...
		public WebDialog build() {
			...
			if (!parameters
					.containsKey(ServerProtocol.DIALOG_PARAM_REDIRECT_URI)) {
